...
- [Uso do cache](#uso-do-cache)
- [Incrementos e Decrementos](#incrementos-e-decrementos)
- [Seções de Cache](#cache-sections)
- [Cache do banco de dados](#cache-do-banco-de-dados)
...
<a name="incrementos-e-decrementos"></a>
